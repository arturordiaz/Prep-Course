...
if (numero == 1 || numero == 0 || numero == 4) return false // AUN NO ENTIENDO POR QUÉ VA EL 4 (CASO ESPECIAL)
for (let i=2 ; i<numero; i++) {
  if (numero%i==0) return false // porque si 
} 
return true
}
...
function doWhile(numero) {
  ...
  let i = 0 // creamos la variable de inicio
  do {
    i=i+1 // condición de corte
    numero = numero + 5
  } while (i<8);
  return numero 
